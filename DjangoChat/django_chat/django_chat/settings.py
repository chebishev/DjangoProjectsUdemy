...
SECRET_KEY = 'django-insecure-kkzvc&vzpe3%=@hod#1i$m*u7t814_7)1=m@*g%+$$uffi2&3x'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [BASE_DIR / "static"]  # for development assets
STATIC_ROOT = BASE_DIR / "staticfiles"    # for collectstatic target
